...
SRC = ft_atoi.c ft_strcat.c ft_strcmp.c ft_strcpy.c ft_strlen.c ft_strncat.c \
		...
		ft_tolower.c ft_strnstr.c ft_strdup.c ft_strchr.c
...
OBJ = ft_atoi.o ft_strcat.o ft_strcmp.o ft_strcpy.o ft_strlen.o ft_strncat.o \
		...
		ft_tolower.o ft_strnstr.o ft_strdup.o ft_strchr.o
...
# OBJ = ft_atoi.o ft_atoi_base.o ft_bzero.o ft_dup.o ft_isalnum.o \
